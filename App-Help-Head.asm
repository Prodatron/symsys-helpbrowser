...
App_BnkNum  db 0                    ;*reserved*                         POST bank number
            db "Help Browser":ds 12:db 0 ;name
...
prgmemtab   db "SymExe10"           ;SymbOS-EXE-identifier              POST table reserved memory areas
            ...
            dw 64*4                 ;additional data memory [link data]
            dw lstlinmax*4          ;additional transfer memory
            ds 26                   ;*reserved*
            db 0,3                  ;required OS version (3.0)
prgicnsml   db 2,8,8,#F3,#FC,#C7,#3E,#9F,#9F,#F7,#3E,#E3,#7C,#F1,#F8,#E3,#7C,#F1,#F8
prgicnbig   db 6,24,24
            db #0F,#0F,#1E,#F0,#C3,#0F,#0F,#0F,#79,#FF,#FC,#0F,#0F,#0F,#F7,#FF,#FF,#87,#0F,#1E,#FF,#FF,#FF,#CB,#0F,#1E,#FF,#F8,#FF,#CB,#0F,#3D,#FF,#87,#F7,#ED,#0F,#3D,#FE,#0F,#7B,#ED,#0F,#3D,#FE,#0F,#F7,#ED
            db #7F,#FD,#FE,#DA,#FF,#CB,#4C,#10,#E0,#71,#FF,#CB,#4C,#00,#00,#F7,#FF,#87,#4C,#2F,#3E,#FF,#FE,#0F,#4C,#00,#10,#FF,#ED,#0F,#4C,#00,#10,#FF,#CB,#0F,#4C,#4F,#9E,#FF,#CB,#0F,#4C,#00,#00,#F0,#87,#0F
            db #4C,#00,#00,#43,#0F,#0F,#4C,#1F,#5F,#F0,#87,#0F,#4C,#00,#10,#FF,#CB,#0F,#4C,#00,#10,#FF,#CB,#0F,#4C,#4F,#9E,#FF,#CB,#0F,#4C,#00,#10,#FF,#CB,#0F,#4C,#00,#00,#F0,#87,#0F,#7C,#F0,#F0,#C3,#0F,#0F
